...
function ($) {
   ...
   RightBar.prototype.selectOptionsFromConfig = function() {
     ...
     */
    RightBar.prototype.toggleRightSideBar = function(target) {

        var elems = document.querySelectorAll(".right-bar-enabled");
        ...
        var self = this;
        $(`.${target}`).toggleClass('right-bar-enabled')
    ...
    RightBar.prototype.init = function() {
        ...
        $(document).on('click', '.right-bar-toggle', function (e) {
            let target = e.currentTarget.getAttribute('for')
            self.toggleRightSideBar(target);
        });
